...
function getFallbackPrompt(decade: string): string {
    return `Produce a high-quality photograph of the person from the uploaded image, styled as if they were from the ${decade}. The image must look like an authentic photograph from that time, with appropriate fashion, hairstyles, and photo characteristics. The person should be clearly visible and the image should be detailed and realistic.`;
}
